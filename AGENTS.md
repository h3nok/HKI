...
pnpm registry:build             # Writes conformance.json (L4-tested when probe evidence present)
...
Current level: **L4-tested (smoke evidence)** (all 28 adapter cases + 10/10 HTTP probes).
