...
Conformance level of the reference platform: **L4-tested (smoke evidence)** (28/28 adapter cases pass; 10/10 HTTP probes pass against the CI mock gateway; Cloud Run probe workflow exists for live external evidence bundles).
...
| 3   | **L4-tested probe evidence (M7 full)** | Done for smoke evidence: `hki probe` HTTP suite passes against the mock gateway; next release artifact should attach live Cloud Run evidence | Q2 2026 |
