...
| Normative standard                |   4.0 | `spec/HKI-1.0.md` now has a canonical Level 0-5 ladder and evidence profiles; community docs define versioning and compatibility process. | Add glossary and non-goals section to the normative spec before 1.0 freeze.                       |
