...
**Updated 2026-05-21** — Tracks 1–3 complete. M17 (examples), M18 (doc reconciliation), M22 (break-a-rag demo), conformance.json upgraded to L4-tested with smoke evidence. M13 AWS example added (`examples/aws-bedrock-rag/`). Open front: full AWS cloud reference, adoption.
...
7. **M26 — Pre-1.0 freeze gate.** Spec, kit, schema, threat catalog frozen
