 ...
 * Verifies that brand-new domains do not inherit readiness points from shared platform health.
...
console.log(
  "TEST 1 — New domain stays at zero despite healthy shared services"
);
