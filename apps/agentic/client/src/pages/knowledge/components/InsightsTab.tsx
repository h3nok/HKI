  ...
  const recommendations = useMemo(() => {
    ...
    if (recs.length === 0) {
      recs.push({
        ...
        description:
          "All services are running and metrics are within expected ranges. Keep building your domain library!",
      });
    }
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                },
                {
                  ...
                  icon: ShieldCheck,
                  color:
                    obs.errorCount > 0 ? "text-primary" : "text-emerald-500",
                  bg: obs.errorCount > 0 ? "bg-primary/8" : "bg-emerald-500/8",
                },
              ].map(s => (
