...
export const BANNERS = {
  ...
  afterGapAnalysis: (coverageScore: number): BannerConfig => ({
    ...
    body: "Test your domain library with real questions your users will ask. This verifies the agent retrieves relevant, accurate chunks for each query.",
    cta: "Test Retrieval",
    tab: "validate",
    section: "test",
    urgency: "success",
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={cn(
            "kb-next-step-banner rounded-xl p-4 flex items-start gap-3",
