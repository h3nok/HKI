    ...
    >
      ...
      <div className="w-full mb-2">
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, color-mix(in srgb, var(--muted-foreground) 38%, var(--background)) 0%, color-mix(in srgb, var(--primary) 58%, var(--muted-foreground) 42%) 42%, var(--primary) 100%)",
          }}
        />
