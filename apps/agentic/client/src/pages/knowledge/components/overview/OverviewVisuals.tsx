...
const TONE_FRAME: Record<Tone, string> = {
  ...
  warning: "border-primary/12 bg-primary/5",
  critical: "border-destructive/20 bg-destructive/8",
...
function toneFillColor(tone: Tone) {
  switch (tone) {
    ...
    case "warning":
      return "color-mix(in srgb, var(--primary) 72%, var(--muted-foreground) 28%)";
    case "critical":
