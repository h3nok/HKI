    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-3 pt-3 space-y-2.5">
        ...
        {batchSummary && batchSummary.total > 1 && (
          <div className={cn(k.inset, "p-2.5")}>
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
              ...
              <div className="flex items-center gap-1.5">
                <FileWarning className="w-3 h-3 text-primary" />
          ...
          {analysis &&
            ...
            analysis.decide.duplicates.length > 0 && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
              >
                <div className="rounded-xl border border-primary/20 bg-primary/4 p-2.5">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    <Copy className="w-3 h-3 text-primary" />
                    <p className={cn(k.label, "text-primary")}>Duplicates</p>
                  </div>
                  <div className="space-y-1.5">
                    {analysis.decide.duplicates.map(
                      (dup: DuplicateMatch, idx: number) => (
                        <div
                          key={idx}
                          className="rounded-lg bg-card/60 dark:bg-card/50 border border-primary/10 p-2"
                        >
        ...
        {analysis && analysis.validate.issues.length > 0 && (
          <div className="rounded-xl border border-primary/15 bg-primary/4 p-2.5">
            <div className="flex items-center gap-1.5 mb-1">
              <AlertTriangle className="w-3 h-3 text-primary" />
              <p className={cn(k.label, "text-primary")}>Issues</p>
            </div>
            <div className="space-y-0.5">
