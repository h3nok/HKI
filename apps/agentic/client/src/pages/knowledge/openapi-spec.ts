...
\`\`\``,
  ...
  servers: [
    ...
    {
      url: "https://knowledge-pipeline.internal.hki.com",
  ...
  tags: [
    ...
    },
    {
      name: "health",
      description:
        "Service health and readiness probes for Kubernetes orchestration.",
    },
  ],
  paths: {
    "/v1/ingest/text": {
    ...
    "/v1/ingest/url": {
      post: {
        ...
        description:
          "Fetch content from a URL and ingest into the domain library.\n\nWhen PUBSUB_ENABLED: publishes to queue. Otherwise inline.",
    ...
    "/v1/jobs": {
      get: {
        ...
        description:
          "List all ingestion jobs with pagination, ordered by creation time.",
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    service: {
                      type: "string",
                      example: "knowledge-pipeline-service",
                    },
                  },
                },
              },
    ...
    schemas: {
      ...
      IngestTextRequest: {
        ...
        properties: {
          ...
          title: {
            type: "string",
            default: "",
            description: "Document title (auto-detected if empty)",
          },
          department: {
            type: "string",
            default: "",
            description: "Organizational department for filtering",
          },
          document_type: {
            type: "string",
            default: "general",
      ...
      IngestURLRequest: {
        ...
        properties: {
          ...
          title: {
            type: "string",
            default: "",
            description: "Document title (auto-detected from page if empty)",
          },
          department: {
            type: "string",
            default: "",
          ...
          follow_links: {
            type: "boolean",
            default: false,
            description: "Whether to crawl linked pages",
          },
        },
      },
      IngestResponse: {
        ...
        properties: {
          ...
          document_id: {
            type: "string",
            nullable: true,
            description: "Vector store document ID (set on completion)",
          },
          chunk_count: {
            type: "integer",
            default: 0,
      ...
      IngestionJob: {
        ...
        properties: {
          ...
          source_ref: {
            type: "string",
            description: "URL or filename of the source",
          },
          title: { type: "string" },
