...
export default function ComponentDemo() {
  usePageMeta("Component Demo — Hermetic");
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p style={{ color: isDark ? "#8B949E" : "#64748B" }}>
              Hermetic isolation mark with a closed domain boundary, knowledge
              spines, and one controlled seam packet.
            </p>
          </div>
          <button
                ...
                style={{
                  background:
                    activeVariant === variant
                      ? "linear-gradient(135deg, var(--primary), color-mix(in srgb, var(--primary) 74%, var(--foreground) 26%))"
                      : isDark
                        ? "#2D3F52"
                        : "#E2E8F0",
                  color:
                  ...
                  boxShadow:
                    activeVariant === variant
                      ? "0 10px 20px -16px color-mix(in srgb, var(--primary) 60%, transparent)"
                      : "none",
                }}
              >
                {variant}
          ...
          <div className="flex items-end justify-around gap-8 py-8">
            <div className="text-center">
              ...
              <p
                ...
                style={{ color: isDark ? "#8B949E" : "#64748B" }}
              >
                Minimal
              </p>
            </div>
