...
/** Generate scope-aware placeholder suggestions from domain metadata */
...
interface RotatingPlaceholderProps {
  ...
  /** Active domain ID */
  scopeId?: string;
  /** Active domain name — drives contextual suggestions */
  scopeName?: string;
  /** Active domain description — enriches placeholder text */
  scopeDescription?: string | null;
  /** Optional LLM-generated prompts for the active domain */
  generatedPrompts?: string[];
}
