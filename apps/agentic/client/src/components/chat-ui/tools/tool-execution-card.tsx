      ...
      {status === "running" && (
        <>
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, color-mix(in srgb, var(--primary) 8%, transparent) 0%, color-mix(in srgb, var(--primary) 4%, transparent) 100%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, var(--primary) 30%, color-mix(in srgb, var(--primary) 72%, var(--foreground)) 70%, transparent 100%)",
            }}
            animate={{ x: ["-100%", "100%"] }}
