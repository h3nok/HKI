...
export function SettingsModal({ open, onOpenChange }: SettingsModalProps) {
  ...
  const agentOptions: AgentOption[] = [
    ...
    },
    {
      ...
      capabilities: ["retrieval", "search", "qa"],
      recommendedFor: ["Knowledge queries"],
    },
    {
      type: "tool-use",
      name: "Tool Executor",
  ...
  const availableTools = [
    { id: "search_knowledge", name: "Search Knowledge" },
    { id: "get_document", name: "Get Document" },
    { id: "run_policy_check", name: "Run Policy Check" },
    { id: "submit_for_review", name: "Submit for Review" },
    { id: "get_audit_trail", name: "Get Audit Trail" },
  ];
  ...
  const registryTools: Tool[] = [
    {
      ...
      description: "Semantic search scoped to the active HKI domain",
      category: "search",
      status: "available",
      parameters: [
        {
      ...
      returns: "Ranked documents from the active domain",
      stats: { totalCalls: 3450, successRate: 0.99, avgDuration: 180 },
    },
    {
      id: "get_document",
      name: "get_document",
      description: "Retrieve a document by ID within the active domain",
      category: "data",
      status: "available",
      parameters: [
        {
      ...
      stats: { totalCalls: 1240, successRate: 0.98, avgDuration: 120 },
    },
    {
      id: "run_policy_check",
      name: "run_policy_check",
      description: "Evaluate an action against domain policy",
      category: "data",
      status: "available",
      parameters: [
        {
    ...
    },
    {
      ...
      description: "Retrieve audit evidence for the active domain",
      category: "data",
      status: "available",
      parameters: [
        {
      ...
      returns: "Audit events with envelope IDs",
            ...
            <div className="flex-1 overflow-y-auto min-h-0 p-6 space-y-6">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {activeTab === "security" && (
                    <div className="space-y-6">
                      <div className="p-4 rounded-lg bg-primary/8 border border-primary/18">
