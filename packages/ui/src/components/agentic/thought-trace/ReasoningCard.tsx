...
const stepConfig = {
    ...
    thought: {
        icon: Brain,
        label: 'Thought',
        color: `var(--primary, ${COSTCO_BLUE})`,
        accentHex: COSTCO_BLUE,
    },
    decision: {
        icon: Lightbulb,
        label: 'Decision',
        ...
        >
            ...
            <button
                ...
                style={{
                    background: isExpanded
                        ? `color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 4%, var(--card))`
                        : 'transparent',
                }}
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: `linear-gradient(135deg, color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 15%, transparent), color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 8%, transparent))`,
                        border: `1px solid color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 20%, var(--border))`,
                    }}
                >
                    <Brain
                        className="w-4 h-4"
                        style={{ color: `var(--primary, ${COSTCO_BLUE})` }}
                    />
                </div>
...
export function InlineReasoning({
    ...
    return (
        <motion.div
            ...
            style={{
                background: `linear-gradient(135deg, color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 4%, var(--card)), color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 2%, var(--card)))`,
                border: `1px solid color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 18%, var(--border))`,
                boxShadow: `0 1px 4px color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 6%, transparent)`,
            }}
        >
            <div
                className="flex items-center justify-center w-6 h-6 rounded-lg shrink-0 mt-0.5"
                style={{
                    background: `color-mix(in srgb, var(--primary, ${COSTCO_BLUE}) 12%, transparent)`,
                }}
            >
                <Sparkles
                    className="w-3 h-3"
            ...
            <p
                ...
                style={{
                    color: `color-mix(in srgb, var(--foreground) 85%, var(--primary, ${COSTCO_BLUE}))`,
                }}
            >
                {content}
            </p>
