...
// --- Layout Constants (Atelier) ---
export const LAYOUT_CONSTANTS = {
  TOPBAR_HEIGHT: 52,
  SIDEBAR_WIDTH: 224,
  SIDEBAR_COLLAPSED_WIDTH: 56,
  CONTEXT_PANEL_WIDTH: 304,
...
export function ContentContainer({
  ...
  return (
    <div
      ...
      style={
        constrained
          ? { maxWidth: `${LAYOUT_CONSTANTS.CONTENT_MAX_WIDTH}px` }
          : undefined
      }
      {...props}
    >
...
export function GridItem({
  ...
  return (
    <div
      className={cn(spanClass, spanMdClass, spanLgClass, className)}
      {...props}
    >
      {children}
    </div>
