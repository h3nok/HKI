...
const variants = cva(
  "min-w-0 text-[14.5px] leading-[1.72] tracking-[-0.012em] sm:text-[15px]",
  {
    variants: {
      author: {
        user: "max-w-[58ch] font-medium text-foreground",
...
function TaskMessageTextContentImpl({
  ...
  return (
    ...
    >
      {content.author === "user" ? (
        <span className="whitespace-pre-wrap wrap-break-word leading-[1.62] text-foreground/92">
          {content.content}
        </span>
      ) : (
