 ...
 * at wider widths. Each tile has a subtle left accent and arrow affordance.
 *
...
function SuggestionTile({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "group relative flex items-center gap-3 text-left w-full",
    ...
    >
      {/* Left accent bar */}
      <div
        className="absolute left-0 top-3 bottom-3 w-0.75 rounded-r-full opacity-60 group-hover:opacity-100 transition-opacity"
