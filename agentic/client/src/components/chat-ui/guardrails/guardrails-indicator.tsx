...
import { Shield, CheckCircle2, AlertTriangle, XCircle, Info, Lock } from 'lucide-react';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
const statusConfig = {
  safe: {
    ...
    borderColor: 'color-mix(in srgb, var(--success, #16a34a) 25%, var(--border))',
    label: 'Safe',
  },
  warning: {
    icon: AlertTriangle,
        ...
        >
          <div className="flex gap-2">
            ...
            <p
              ...
              style={{ color: 'color-mix(in srgb, var(--primary) 80%, var(--foreground))' }}
            >
              Guardrails protect against harmful content, PII leakage, and hallucinations.
            </p>
          </div>
        </div>
      </PopoverContent>
