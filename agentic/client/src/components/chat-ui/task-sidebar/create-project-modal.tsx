...
export interface CreateProjectModalProps {
    open: boolean;
    onClose: () => void;
    onSubmit: (params: { name: string; emoji?: string; color?: string }) => Promise<any>;
...
export function CreateProjectModal({ open, onClose, onSubmit, initialName = '' }: CreateProjectModalProps) {
            ...
            >
                ...
                <div className="flex items-center justify-between px-6 pt-5 pb-2">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 id="create-project-title" className="text-[15px] font-semibold tracking-wide text-foreground uppercase">
                            New Project
                        </h2>
                    </div>
                    <button
                ...
                <div className="px-6 pb-6 pt-3 space-y-5">
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-xl border border-border/60 bg-muted/30">
                        <div
                            ...
                            style={{
                                ...
                                border: color ? `1.5px solid ${color}30` : '1.5px solid transparent',
                            }}
                        >
                            {emoji}
                        </div>
                    ...
                    {/* ── Name Input ── */}
                    <div>
                        <label htmlFor="project-name" className="block text-xs font-medium text-foreground/80 mb-1.5 uppercase tracking-wider">
                            Name
                        </label>
                        <input
                            ref={inputRef}
                    ...
                    {/* ── Emoji Picker ── */}
                    <div>
                        <label className="block text-xs font-medium text-foreground/80 mb-1.5">Icon</label>
                    ...
                    {/* ── Color Picker ── */}
                    <div>
                        <label className="block text-xs font-medium text-foreground/80 mb-1.5">Accent Color</label>
