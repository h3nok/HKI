...
export interface TaskSidebarProps {
  ...
  /** Active value stream name for the sidebar badge */
  activeStreamName?: string;
  /** Active value stream icon */
  activeStreamIcon?: string;
  /** Active value stream ID for scoped workspace navigation */
  activeScopeId?: string;
  /** Whether the chat is locked to a URL-scoped value stream */
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            aria-label="Tasks"
            className={cn(
              "flex flex-col h-full shrink-0 overflow-hidden bg-sidebar/90 backdrop-blur-3xl border-r border-border/50",
              isMobile
