...
function CopyButton({ content, className }: { content: string; className?: string }) {
  ...
  return (
    <motion.button
      ...
      style={{
        background: copied ? 'color-mix(in srgb, var(--success, #16a34a) 15%, transparent)' : 'transparent',
      }}
      title={copied ? 'Copied!' : 'Copy'}
      aria-label={copied ? 'Copied to clipboard' : 'Copy to clipboard'}
    >
      {copied ? (
        <Check className="h-3 w-3" style={{ color: 'var(--success, #16a34a)' }} />
      ) : (
      ...
      <div style={{ marginLeft: level > 0 ? 16 : 0 }}>
        ...
        >
          ...
          >
            ...
            <Brackets className="h-3 w-3" style={{ color: TOKENS.colors.bracket }} />
      ...
      <div style={{ marginLeft: level > 0 ? 16 : 0 }}>
        ...
        >
          ...
          >
            ...
            <Braces className="h-3 w-3" style={{ color: TOKENS.colors.bracket }} />
            <span style={{ color: 'var(--muted-foreground)' }}>
...
export function JsonViewer({
  ...
  const shouldShowExpand = useMemo(() => {
    return forceExpandState === null ? defaultOpenDepth === 0 : !forceExpandState;
