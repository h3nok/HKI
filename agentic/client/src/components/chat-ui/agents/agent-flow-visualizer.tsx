...
function AgentCard({ agent, isActive }: { agent: AgentNode; isActive: boolean }) {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `color-mix(in srgb, ${fromConfig.color} 15%, transparent)` }}
      >
        <fromConfig.icon className="h-3.5 w-3.5" style={{ color: fromConfig.color }} />
      </div>
      ...
      <div
        className="p-1.5 rounded-md"
        style={{ background: `color-mix(in srgb, ${toConfig.color} 15%, transparent)` }}
      >
        <toConfig.icon className="h-3.5 w-3.5" style={{ color: toConfig.color }} />
      </div>
