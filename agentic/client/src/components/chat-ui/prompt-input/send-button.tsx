  ...
  const buttonStyle =
    mode === "interrupt"
      ? {
          ...
          borderColor:
            "color-mix(in srgb, var(--secondary) 18%, rgba(255, 255, 255, 0.08))",
          boxShadow:
          ...
          {showInterrupt ? (
            ...
            >
              <motion.span
                ...
                style={{
                  boxShadow:
                    "inset 0 0 0 1px color-mix(in srgb, var(--secondary) 28%, transparent), 0 0 0 1px color-mix(in srgb, var(--secondary) 18%, transparent)",
                }}
              />
