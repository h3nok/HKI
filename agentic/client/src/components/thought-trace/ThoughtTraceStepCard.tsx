...
type StepTypeConfig = { icon: LucideIcon; label: string; color: string; bgColor: string };
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isExpanded && 'shadow-sm ring-1 ring-black/[0.02] dark:ring-white/[0.02]',
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className={cn('px-1.5 py-0.5 text-[9px] font-semibold rounded-md', typeConfig.bgColor, typeConfig.color)}>
              {typeConfig.label}
            </span>
          </div>
          {step.agentName && (
