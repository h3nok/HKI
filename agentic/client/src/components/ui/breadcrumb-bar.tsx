...
export function BreadcrumbBar({
  ...
  return (
    <header
      className={cn(
        "dashboard-breadcrumb sticky top-0 z-40 flex h-14 shrink-0 items-center gap-2 px-4 sm:px-5",
        className
      )}
    >
      <SidebarTrigger className="dashboard-toolbar-button dashboard-toolbar-button--icon -ml-1 size-8 rounded-xl text-muted-foreground hover:text-foreground" />
