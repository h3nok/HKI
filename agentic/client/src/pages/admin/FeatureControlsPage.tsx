    ...
    () => [
      {
        ...
        icon: Gauge,
        badge:
          rolloutIssueCount === 0 ? "" : `${rolloutIssueCount} issues`,
      ...
      },
      {
        ...
        description: "",
        icon: Users,
        badge: `${configuredStreams.length} streams`,
        tone: "primary",
      },
      {
        key: "debug",
              ...
              <div className="min-w-0 space-y-5">
                ...
                <TabsContent value="overview" className="mt-0 space-y-5">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <SettingsAreaCard
                      title="Value Streams"
                      description={`${configuredStreams.length} streams configured`}
                      icon={Layers}
                      tone="warning"
                      stats={[]}
                      actionLabel="Manage streams"
                      actionIcon={Layers}
