      ...
      >
        <div className="relative z-10 flex flex-col lg:flex-row">
          <div
            className={cn(
              a.dataPanel,
              "flex flex-1 flex-col border-b border-border/18 backdrop-blur-sm lg:border-b-0 lg:border-r"
            )}
          >
            <div
              className={cn(
            ...
            <div className="grid grid-cols-2 gap-3 p-3">
              {stats.map(stat => (
                <div
                  ...
                  className={cn(
                    a.metricCard,
                    "group relative flex min-h-28 flex-col justify-between overflow-hidden rounded-[1.35rem] px-5 py-4 transition-all duration-300 hover:border-primary/24"
                  )}
                >
          ...
          {/* Content Aware Pipeline Preview Section */}
          {activeJobs.length > 0 && (
            <div
              className={cn(
                a.dataPanel,
                "flex min-h-35 flex-1 flex-col gap-3 border-t border-border/16 p-5 backdrop-blur-sm lg:min-h-0 lg:max-w-md lg:border-t-0"
              )}
            >
              ...
              <div className="space-y-2">
                {activeJobs.map((job: any) => (
                  <div
                    ...
                    className={cn(
                      a.previewRow,
                      "flex items-center justify-between p-3 rounded-xl group hover:border-primary/30 transition-all"
                    )}
                  >
                    <div className="flex items-center gap-3">
                      <div
