...
function getSettingsButtonClass(variant: ButtonProps["variant"]) {
  switch (variant) {
    case "brand":
      return "border border-[#004b87] bg-[#005da6] text-white shadow-[0_1px_2px_rgba(15,23,42,0.08),0_8px_20px_rgba(0,93,166,0.16)] hover:bg-[#004b87] hover:text-white hover:shadow-[0_1px_2px_rgba(15,23,42,0.1),0_12px_24px_rgba(0,93,166,0.2)]";
    case "outline":
