/**
 * Value Streams Page — CRUD for business domains
 *
 * Create, edit, delete value streams. Each stream scopes the agent
 * to a specific business domain (pharmacy, logistics, etc.).
 */
    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground/80 max-w-sm mx-auto leading-relaxed">
          Save this value stream first, then configure its knowledge
          collections.
        </p>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground">
            ...
            assigned — each scopes which documents this stream's agent can
            search.
          </p>
        </div>
        <a
        ...
        >
          <BookOpen className="w-3 h-3" /> Open Knowledge Base
      ...
      {collections.length > 0 ? (
                ...
                <button
                  onClick={() =>
                    setConfirmDialog({
                      title: `Remove "${c.name}"?`,
                      description:
                        "This collection will be unlinked from the workspace. Documents remain in the knowledge base.",
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            No collections yet. Add one to scope this stream's knowledge.
          </p>
        </div>
      )}
...
// ═══════════════════════════════════════════════════════════════════════════════
// Stream Form (create / edit) — tabbed wizard
// ═══════════════════════════════════════════════════════════════════════════════
  ...
  const promptLayers = [
    ...
    },
    {
      ...
      desc: form.systemPrompt
        ? "Custom stream-specific overlay that shapes tone, terminology, and escalation boundaries."
        : "No custom persona saved. The orchestrator will use the scope-aware default overlay for this stream.",
              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="What does this value stream cover?"
                    rows={2}
                ...
                <div className={cn(a.inset, "p-4 rounded-2xl space-y-3")}>
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
                      This form only edits the stream-level persona layer. The
                      ...
                      <div className="p-3 rounded-lg border border-border space-y-3">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-0.5">
                            Choose how aggressively this stream escalates to
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="text-[10px] text-muted-foreground mt-0.5">
                            ...
                            blocked actions for this stream.
                          </p>
                        </div>
                        <div className="w-40">
                          <Select
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {[
                            ...
                            },
                            {
                              ...
                              title: "Blocked",
                              desc: "Removed from execution for this stream.",
                ...
                <div className="p-4 rounded-2xl border border-border/50 bg-muted/30">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        Platform-level setting — applies to all streams
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-6">
                <div className="p-4 rounded-2xl border border-border/50 bg-muted/30">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground">
                        Optional per-stream override for AI assist routing and
                        billing
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-[10px] text-muted-foreground/70 mt-2">
                    ...
                    KB self-service still works without a stream key; this only
                ...
                <div className={cn(a.inset, "p-4 rounded-2xl")}>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Stream-level budgets, quotas, and spending controls are
                    managed in the external FinOps workspace. Use the API key
                    above only when this stream needs a routing override; leave
...
export default function StreamsPage() {
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        title="Value Streams"
        description="Define business-domain workspaces, system prompts, tool permissions, and knowledge policy for each agent surface in the control plane."
        icon={Layers}
        action={
          <button
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
                Value streams scope the AI agent to a business domain. Each
                stream gets its own persona, knowledge base, tools, and
                guardrails.
              </p>
            </div>
            <button
            ...
            >
              <Plus className="w-4 h-4" /> New Value Stream
            </button>
          </div>
        )}
                        ...
                        <IconAction
                          ...
                          onClick={() =>
                            setConfirmDialog({
                              title: `Delete "${s.name}"?`,
                              description:
                                "All users will be unassigned from this workspace. This action cannot be undone.",
