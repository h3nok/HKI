 ...
 *
 * List users, assign roles, assign value streams, toggle active status.
 */
...
// ═══════════════════════════════════════════════════════════════════════════════
// Stream Assignment Dropdown (per-user multi-select)
// ═══════════════════════════════════════════════════════════════════════════════
...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        title="Users & Access"
        description="Manage control-plane access, role elevation, and stream scope. New users should stay on the standard viewer path until you intentionally expand their permissions."
        icon={Users}
        action={
          !showInvite ? (
            <button
      ...
      >
        Platform Admins manage enterprise role tiers here. Stream membership is
        managed separately in the Value Streams column and determines where a
