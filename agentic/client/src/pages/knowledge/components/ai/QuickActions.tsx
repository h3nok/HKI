...
export const AI_ACTIONS = {
  ...
  healthCheck: (opts: {
    ...
    description: "Get an AI-powered assessment of your knowledge base health",
    ...
    onExecute: async () => {
      const { answer } = await opts.mutate({
        page: opts.page,
        question:
          "Give me a brief health assessment of my knowledge base. What's working well and what needs attention? Be specific with numbers.",
