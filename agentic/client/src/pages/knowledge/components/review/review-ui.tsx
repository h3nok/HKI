              ...
              {duplicateCount > 0 || contradictionCount > 0 ? (
                <div className="mt-1.5 flex flex-wrap gap-1.5">
                  {duplicateCount > 0 ? (
                    <Badge
                      variant="outline"
                      className="rounded-full border-amber-500/25 bg-amber-500/8 px-2 py-0.5 text-[11px] text-amber-700 dark:text-amber-300"
                    >
...
export function ReviewQueuePanel({
  ...
  return (
    <HkiCard interactive={false} className="overflow-hidden">
                      ...
                      <div className="space-y-2">
                        {reviewIntelligence.duplicates.map(match => (
                          <div
                            ...
                            className="rounded-lg border border-amber-500/20 bg-amber-500/6 px-3 py-2.5"
                          >
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <Badge
                                variant="outline"
                                className="rounded-full border-amber-500/25 bg-background/70 px-2 py-0.5 text-[11px] text-amber-700 dark:text-amber-300"
                              >
        ...
        <div className="space-y-3 p-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button
              ...
              disabled={isActing}
              size="sm"
              className="gap-1.5 border-amber-500/35 text-amber-700 hover:bg-amber-500/10 dark:text-amber-300"
            >
