...
const HERO_COPY: Record<string, { title: string; description: string }> = {
  guidelines: {
    ...
    description:
      "Set the rules and review posture before content starts flowing into the stream.",
  },
  "gap-analysis": {
    title: "Find the Open Space",
    description:
      "See what the knowledge base still cannot answer and target the next highest-value content.",
  },
  "first-ingest": {
...
export default function OverviewTab({
  ...
  const contentSummary = useMemo(() => {
    ...
    const readyToPublishCount = reviewAllQ.isSuccess ? approvedReviews.length : 0;
      ...
      return {
        ...
        description:
          contentSummary.liveCount > 0
            ...
            : "Seed the workspace with documents and connectors so searchable knowledge can start taking shape.",
        primaryLabel:
    ...
    return {
      title:
        contentSummary.liveCount > 0
          ...
          : "This Workspace Is Still Warming Up",
      description:
        contentSummary.liveCount > 0
          ? "Use the library and agent to explore the published content available for this stream."
