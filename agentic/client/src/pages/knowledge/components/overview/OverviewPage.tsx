  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "radial-gradient(64% 54% at 18% 0%, rgba(248,251,253,0.28) 0%, rgba(248,251,253,0) 62%), linear-gradient(180deg, rgba(0,102,178,0.03) 0%, rgba(0,102,178,0) 38%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(8,12,18,0.02) 0%, rgba(8,12,18,0.16) 100%)",
        }}
      />
      <KnowledgeBookIllustration horizontal />
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-24 dark:hidden"
        style={{
          background:
            "linear-gradient(180deg, rgba(248,251,253,0) 0%, rgba(248,251,253,0.06) 100%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 hidden h-24 dark:block"
        style={{
          background:
            "linear-gradient(180deg, rgba(7,11,16,0) 0%, rgba(7,11,16,0.24) 100%)",
        }}
      />
    </>
  );
...
function DashboardBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute -left-24 top-16 h-72 w-72 rounded-full bg-primary/6 blur-3xl" />
      <div className="absolute -right-24 top-56 h-80 w-80 rounded-full bg-primary/4 blur-3xl" />
    </div>
  );
}
...
function HeroActionButton({
  ...
  const sharedClassName = cn(
    "h-10 gap-1.5 rounded-2xl px-4 transition-[box-shadow,border-color,background-color,color] duration-200",
    emphasis === "primary"
      ? cn(
          "border border-primary/16 shadow-[inset_0_1px_0_rgba(255,255,255,0.34),0_10px_18px_-22px_rgba(0,102,178,0.38)] dark:border-primary/12 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]",
          k.duoToneAccentSolid,
          k.duoToneAccentSolidHover
        )
      : cn(
          "border border-border/45 bg-white/86 text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.72),0_10px_18px_-24px_rgba(15,23,42,0.12)] hover:border-primary/12 hover:bg-white dark:border-white/8 dark:bg-white/3 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] dark:hover:bg-white/5",
          k.duoToneHover,
          k.duoToneTextHover
        )
  );
...
function HeroTitleLockup({ title }: { title: string }) {
  ...
  if (!preset) {
    return (
      <h1 className="max-w-none whitespace-nowrap text-[clamp(0.88rem,3.6vw,1.75rem)] font-bold leading-none tracking-tight text-foreground">
        {title}
      </h1>
    );
  }
  ...
  return (
    <h1 className="max-w-none whitespace-nowrap text-[clamp(0.88rem,3.6vw,1.75rem)] font-extrabold leading-none tracking-tight text-foreground">
...
function OverviewHero({ hero }: { hero: OverviewHeroModel }) {
  return (
    <SurfaceCard
      variant="default"
      className="relative overflow-hidden rounded-[30px] border border-border/30 bg-card px-7 py-6 lg:px-9 lg:py-7 dark:border-white/6 dark:bg-card"
    >
      <HeroBrandDecoration />
