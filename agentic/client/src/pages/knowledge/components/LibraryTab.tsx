  ...
  const libraryWorkflow = useMemo(() => {
      ...
      if (totalDocumentCount === 0) {
        return {
          ...
          description: canWriteKnowledge
            ? "Upload or connect a source to seed this workspace. New documents will appear here once processing completes."
            : "This workspace does not have any indexed documents yet.",
          primaryAction:
    ...
    if (approvedReviewHistoryCount > 0) {
      return {
        ...
        description:
          "Publish approved documents to make them searchable in the knowledge base.",
        primaryAction: onNavigate
          ? {
              label: "Review queue",
              onClick: () => onNavigate("govern", "review"),
