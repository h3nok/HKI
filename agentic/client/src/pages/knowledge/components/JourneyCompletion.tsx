  ...
  return (
    <div className="relative">
      ...
      >
        ...
        >
          <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-amber-400 via-amber-500 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-500/30">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-foreground mb-2">
            {isHealthy ? (
              ...
              <>
                ...
                <span className="text-amber-500">Keep Improving</span>
              </>
            )}
          </h2>
