  ...
  return (
    ...
    >
      ...
      <rect
        ...
        strokeWidth="1.2"
      />
      <path d="M 94 98 L 100 104 L 94 104 Z" fill="#F59E0B" fillOpacity="0.2" />
      <rect
        x="84"
        y="108"
        width="10"
...
function IllustrationFresh({ className }: { className?: string }) {
  ...
  const bars = [
    ...
    { x: 130, color: "#F59E0B", h: 48, pct: "62%" },
...
const PLAYBOOK: PlaybookStep[] = [
  ...
  },
  {
    ...
    pitfall:
      "Setting it up once and forgetting it. The best knowledge bases are maintained as living documents.",
  },
];
          ...
          >
            ...
            {isIntro && (
              <div className={cn(k.card, "p-8 space-y-7")}>
                ...
                {/* Notice */}
                <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-50 dark:bg-amber-500/8 border border-amber-200/60 dark:border-amber-500/20">
                  <Lock className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
                  <div>
                    <p className="text-base font-semibold text-amber-800 dark:text-amber-300">
                      Please read before continuing
                    </p>
                    <p className="text-base text-amber-700 dark:text-amber-400 mt-0.5">
