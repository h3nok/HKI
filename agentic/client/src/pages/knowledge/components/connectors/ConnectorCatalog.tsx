          ...
          {filtered.map(source => {
            ...
            return (
              ...
              >
                {/* Popular badge */}
                {source.popular && (
                  <span className="absolute top-2 right-2 px-2 py-0.5 text-xs font-bold uppercase tracking-wider rounded bg-amber-500/10 text-amber-600 dark:text-amber-400">
                    Popular
                  </span>
                )}
