        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground/60 mt-0.5">
              How well your knowledge base covers the agent's needs
            </p>
            {valueStreamId &&
      ...
      {staleDocs.length > 0 && (
        <div className={cn("overflow-hidden", cardCls)}>
          <div className="border-b border-border/30 dark:border-border/30 px-5 py-3">
            <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
              <FileWarning className="w-4 h-4 text-amber-500" /> Stale Content
              <span className="px-1.5 py-0.5 text-xs font-semibold rounded-full bg-amber-500/10 text-amber-500">
                {staleDocs.length}
              </span>
            </h3>
          </div>
