/**
 * Knowledge Sidebar — Navigation, stream workspace identity,
...
export default function KnowledgeSidebar() {
  ...
  const footerActionClass =
    "inline-flex items-center justify-center rounded-lg p-2 text-secondary/70 transition-colors hover:bg-secondary/10 hover:text-secondary";
        ...
        <SidebarMenu className="mb-2 gap-1">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              tooltip="Report Bug"
              className={cn(
                "dashboard-nav-button rounded-xl border border-destructive/20 bg-destructive/8 text-sm font-semibold text-destructive transition-colors hover:bg-destructive/10 hover:text-destructive",
            ...
            >
              ...
              {!isCollapsed && (
                <span className="flex-1 truncate">Report Bug</span>
              )}
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    <span className="ml-auto inline-flex items-center justify-center rounded-lg p-1.5 text-secondary/60 transition-colors group-data-[state=open]:bg-secondary/10 group-data-[state=open]:text-secondary">
