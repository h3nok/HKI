...
export default function KnowledgeContent() {
    ...
    () => [
      {
        ...
        description:
          docCount > 0
            ...
            : "Upload files, paste text, or connect a source to seed your knowledge base.",
        outcome:
  ...
  const PAGE_META: Record<KnowledgeTab, { title: string; desc: string }> = {
    ...
    ingest: {
      title: "Add",
      desc: "Add files, text, links, or connected sources to your knowledge base.",
    },
    library: {
      title: "Library",
                ...
                {showPlaybookPrompt ? (
                  <div className="mt-0.5 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      It shows what belongs in this stream, how to keep answers
