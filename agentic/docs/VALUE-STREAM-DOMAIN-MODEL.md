...
Every user interaction on the platform is scoped to a value stream. The special `global` stream ("Employee Copilot") is a catch-all for cross-domain queries.
...
| **Unique Needs**   | Fallback agent — routes to domain-specific agents when scope mismatch is detected  |
...
│                                                                 │
│  ┌─────────────────┐                                           │
│  │ Employee Copilot │  (global — cross-domain fallback)       │
│  │ ✨ All tools     │                                          │
│  │    All knowledge │                                          │
│  └─────────────────┘                                           │
└─────────────────────────────────────────────────────────────────┘
